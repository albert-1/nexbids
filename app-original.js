...
,
  ...
  '2 business days': {zh:'2个工作日', es:'2 días hábiles', fr:'2 jours ouvrés', pt:'2 dias úteis', hi:'2 कार्यदिवस', ar:'يومان عमل', ja:'2営業日'},
  'P1 < 1hr, Std < 4hrs': {en:'P1 < 1hr, Std < 4hrs', zh:'P1 <1小时，标准 <4小时', es:'P1 < 1h, Std < 4h', fr:'P1 < 1h, Std < 4h', pt:'P1 < 1h, Padrão < 4h', hi:'P1 < 1 घंटा, Std < 4 घंटे', ar:'P1 < ساعة واحدة، Std < 4 ساعات', ja:'P1 < 1時間、標準 < 4時間'},
  'Audience Similarity (Lookalike)': {zh:'受众相似度（相似受众）', es:'Similitud de Audiencia (Lookalike)', fr:'Similarité d\'Audience (Sosie)', pt:'Similaridade de Audiência (Lookalike)', hi:'ऑडियंस सिमिलैरिटी (लुकअलाइक)', ar:'تشابह الجمهور (المشابه)', ja:'オーディエンス類似（ルックアライク）'},
  ...
  // ── Technology Philosophy Cards ──
  'Intelligent': { es:'Inteligente', fr:'Intelligent', de:'Intelligent', pt:'Inteligente', ru:'Умный', zh:'智能的', ko:'지능형', ja:'インテリジェント', ms:'Cerdas', th:'อัจฉริยะ', vi:'Thông Minh', hi:'बुद्धिमान', ar:'ذكي' },
  // ── Login Page Texts ──
  'Back to nexbids.com': { es:'Volver a nexbids.com', fr:'Retour à nexbids.com', de:'Zurück zu nexbids.com', pt:'Voltar para nexbids.com', ru:'Вернуться на nexbids.com', zh:'返回 nexbids.com', ko:'nexbids.com으로 돌아가기', ja:'nexbids.comに戻る', ms:'Kembali ke nexbids.com', th:'กลับไปที่ nexbids.com', vi:'Quay lại nexbids.com', hi:'nexbids.com पर वापस जाएं', ar:'العودة إلى nexbids.com' },
  'Enter your credentials to access the platform.': { es:'Ingrese sus credenciales para acceder a la plataforma.', fr:'Entrez vos identifiants pour accéder à la plateforme.', de:'Geben Sie Ihre Anmeldedaten ein, um auf die Plattform zuzugreifen.', pt:'Digite suas credenciais para acessar a plataforma.', ru:'Введите свои учетные данные для доступа к платформе.', zh:'输入您的凭据以访问平台。', ko:'플랫폼에 액세스하려면 자격증명을 입력하세요.', ja:'プラットフォームにアクセスするための認証情報を入力してください。', ms:'Masukkan kredensial Anda untuk mengakses platform.', th:'ป้อนข้อมูลประจำตัวของคุณเพื่อเข้าถึงแพลตฟอร์ม', vi:'Nhập thông tin đăng nhập của bạn để truy cập nền tảng.', hi:'प्लेटफॉर्म तक पहुंचने के लिए अपनी साख दर्ज करें।', ar:'أدخل بيانات اعتمادك للوصول إلى المنصة.' },
  'Email Address': { es:'Dirección de correo electrónico', fr:'Adresse e-mail', de:'E-Mail-Adresse', pt:'Endereço de email', ru:'Адрес электронной почты', zh:'邮箱地址', ko:'이메일 주소', ja:'メールアドレス', ms:'Alamat Email', th:'ที่อยู่อีเมล', vi:'Địa chỉ Email', hi:'ईमेल पता', ar:'عنوان البريد الإلكتروني' },
  'Password': { es:'Contraseña', fr:'Mot de passe', de:'Passwort', pt:'Senha', ru:'Пароль', zh:'密码', ko:'비밀번호', ja:'パスワード', ms:'Kata Sandi', th:'รหัสผ่าน', vi:'Mật khẩu', hi:'पासवर्ड', ar:'كلمة المرور' },
  'Remember me': { es:'Recuérdame', fr:'Se souvenir de moi', de:'Passwort speichern', pt:'Lembre-se de mim', ru:'Запомнить меня', zh:'记住我', ko:'기억하기', ja:'自分を覚えておく', ms:'Ingat saya', th:'จำฉันไว้', vi:'Nhớ tôi', hi:'मुझे याद रखें', ar:'تذكرني' },
  'Sign In': { es:'Iniciar sesión', fr:'Se connecter', de:'Anmelden', pt:'Entrar', ru:'Войти', zh:'登录', ko:'로그인', ja:'ログイン', ms:'Masuk', th:'ลงชื่อเข้า', vi:'Đăng nhập', hi:'साइन इन करें', ar:'تسجيل الدخول' },
  'Help': { es:'Ayuda', fr:'Aide', de:'Hilfe', pt:'Ajuda', ru:'Помощь', zh:'帮助', ko:'도움말', ja:'ヘルプ', ms:'Bantuan', th:'ความช่วยเหลือ', vi:'Trợ giúp', hi:'मदद', ar:'مساعدة' },
  'Not just automated — genuinely smart. Our ML systems learn and improve continuously from every auction signal.': { es:'No es solo automatización, es genuinamente inteligente. Nuestros sistemas ML aprenden y mejoran continuamente de cada señal de subasta.', fr:'Ce n\'est pas seulement automatisé — c\'est vraiment intelligent. Nos systèmes ML apprennent et s\'améliorent continuellement à partir de chaque signal d\'enchère.', de:'Nicht nur automatisiert — echte Intelligenz. Unsere ML-Systeme lernen kontinuierlich aus jedem Auktionssignal und verbessern sich.', pt:'Não é apenas automatizado — é genuinamente inteligente. Nossos sistemas ML aprendem e melhoram continuamente de cada sinal de leilão.', ru:'Это не просто автоматизация — это подлинный интеллект. Наши системы ML постоянно учатся и совершенствуются на основе каждого сигнала аукциона.', zh:'不仅仅是自动化，而是真正智能。我们的ML系统从每个竞价信号持续学习和改进。', ko:'자동화일 뿐만 아니라 진정으로 지능형입니다. 우리의 ML 시스템은 모든 경매 신호에서 지속적으로 학습하고 개선됩니다.', ja:'自動化されているだけでなく、本当に賢いです。当社のMLシステムは、すべてのオークション信号から継続的に学習し、改善されます。', ms:'Bukan hanya automatisasi — benar-benar pintar. Sistem ML kami terus belajar dan meningkat dari setiap sinyal lelang.', th:'ไม่ใช่แค่ระบบอัตโนมัติ มันเป็นระบบที่แท้จริงอัจฉริยะ ระบบ ML ของเราเรียนรู้และปรับปรุงอย่างต่อเนื่องจากสัญญาณการประมูลทุกครั้ง', vi:'Không chỉ tự động hóa — thực sự thông minh. Các hệ thống ML của chúng tôi liên tục học hỏi và cải thiện từ mọi tín hiệu đấu giá.', hi:'सिर्फ स्वचालन नहीं — वास्तव में स्मार्ट। हमारी ML प्रणालियां हर नीलामी सिग्नल से लगातार सीखती और सुधार करती हैं।', ar:'ليست مجرد أتمتة — بل ذكية حقًا. تتعلم أنظمتنا الآلية وتتحسن باستمرار من كل إشارة مزايدة.' },
  'Fast': { es:'Rápido', fr:'Rapide', de:'Schnell', pt:'Rápido', ru:'Быстро', zh:'快速的', ko:'빠른', ja:'高速', ms:'Cepat', th:'เร็ว', vi:'Nhanh', hi:'तेज', ar:'سريع' },
  'Millisecond-level decisions at global scale. Sub-100ms bid processing at 50B+ daily requests.': { es:'Decisiones de nivel milisegundo a escala global. Procesamiento de ofertas sub-100ms con 50B+ solicitudes diarias.', fr:'Décisions au niveau des millisecondes à l\'échelle mondiale. Traitement des enchères <100ms avec 50B+ requêtes quotidiennes.', de:'Entscheidungen auf Millisekundenbasis im globalen Maßstab. Geboteverarbeitung <100ms bei 50B+ täglichen Anfragen.', pt:'Decisões em nível de milissegundo em escala global. Processamento de lances <100ms com 50B+ requisições diárias.', ru:'Решения на уровне миллисекунд в глобальном масштабе. Обработка ставок <100ms при 50B+ суточных запросов.', zh:'全球规模下毫秒级决策，不做任何妥协。在500亿+日请求下竞价处理低于100毫秒。', ko:'글로벌 규모의 밀리초 단위 의사결정. 50B+ 일일 요청에서 100ms 미만의 입찰 처리.', ja:'グローバル規模でのミリ秒単位の意思決定。50B+日次リクエストで<100ms入札処理。', ms:'Keputusan peringkat milidetik dalam skala global. Pemrosesan tawaran <100ms dengan 50B+ permintaan harian.', th:'การตัดสินใจในระดับมิลลิวินาทีในมาตราส่วนทั่วโลก การประมวลผลการเสนอราคา <100ms ด้วยคำขอ 50B+ รายวัน', vi:'Quyết định ở mức mili giây ở quy mô toàn cầu. Xử lý đấu giá <100ms với 50B+ yêu cầu hàng ngày.', hi:'वैश्विक पैमाने पर मिलीसेकंड स्तर के निर्णय। 50B+ दैनिक अनुरोधों के साथ <100ms बिड प्रोसेसिंग।', ar:'قرارات على مستوى الميلي ثانية على نطاق عالمي. معالجة العروض أقل من 100ms مع 50B+ طلبات يومية.' },
  'Transparent': { es:'Transparente', fr:'Transparent', de:'Transparent', pt:'Transparente', ru:'Прозрачность', zh:'透明的', ko:'투명한', ja:'透明性', ms:'Telus', th:'โปร่งใส', vi:'Minh Bạch', hi:'पारदर्शी', ar:'شفاف' },
  'Privacy-First': { es:'Privacidad Primero', fr:'Confidentialité d\'abord', de:'Datenschutz an erster Stelle', pt:'Privacidade em Primeiro Lugar', ru:'Конфиденциальность превыше всего', zh:'隐私优先的', ko:'프라이버시 우선', ja:'プライバシーファースト', ms:'Privasi Pertama', th:'ความเป็นส่วนตัวอันดับแรก', vi:'Quyền Riêng Tư Trước Tiên', hi:'गोपनीयता प्रथम', ar:'الخصوصية أولاً' },
  'Reliable': { es:'Confiable', fr:'Fiable', de:'Zuverlässig', pt:'Confiável', ru:'Надежный', zh:'可靠的', ko:'신뢰할 수 있는', ja:'信頼性', ms:'Boleh Dipercaya', th:'น่าเชื่อถือ', vi:'Đáng Tin Cậy', hi:'विश्वसनीय', ar:'موثوق' },
  'Global': { es:'Global', fr:'Mondial', de:'Global', pt:'Global', ru:'Глобальный', zh:'全球化的', ko:'글로벌', ja:'グローバル', ms:'Global', th:'ระดับโลก', vi:'Toàn Cầu', hi:'वैश्विक', ar:'عالمي' },
  ...
  'Demand-Side Platform': { es:'Plataforma de Demanda', fr:'Plateforme', de:'Demand-Side-Plattform', pt:'Plataforma', ru:'Платформа', ko:'플랫폼', ja:'プラットフォーム', ar:'منصة' }
};
...
function renderPage(page) {
  console.log('[DEBUG] renderPage("' + page + '") called');
  ...
  try {
    console.log('[DEBUG] Calling actualFn() for page:', page);
    const html = actualFn();
    console.log('[DEBUG] Got ' + html.length + ' chars from actualFn()');
...
───────────────────────────────────────────── */
function renderHome() {
  console.log('[DEBUG] renderHome() called');
  return `
  <section class="hero">
    <div class="container">
      <div class="hero-text">
        <h1>${t('The Fastest Programmatic Advertising Platform', '最快的程序化广告平台')}</h1>
        <p class="hero-subtitle">${t('Proven to increase ROAS by 3.2x | Real-time bidding at scale with unmatched speed, control, and ROI', '经证实可将ROAS提高3.2倍 | 大规模实时竞价，具有无与伦比的速度、控制力和投资回报率')}</p>
        <div class="btn-group">
      ...
      <div class="card-grid card-grid-3 swipeable" style="margin-bottom:64px">
        ${[
          [
            ...
            'I want to advertise with NexBids','我想在NexBids投放广告','Speak with our advertiser sales team about launching campaigns, pricing, or getting a platform demo.','与我们的广告主销售团队交流，了解启动营销活动、定价或获取平台演示。','Contact Advertiser Sales','联系广告主销售','1 business day', '1 business day'],
          [
            ...
            'I want to monetize my traffic','我想变现我的流量','Connect with our publisher partnerships team to discuss SSP integration and monetization strategy.','联系我们的发布商合作伙伴团队，讨论SSP集成和变现策略。','Contact Publisher Team','联系发布商团队','1 business day', '1 business day'],
          [
            ...
            'I\'m an agency looking to partner','我是一家代理商，希望合作','Talk to our agency partnerships team about commercial arrangements and platform access.','与我们的代理商合作伙伴团队交流商业安排和平台访问。','Contact Agency Partnerships','联系代理商合作伙伴','1 business day', '1 business day'],
          [
            ...
            'I need technical support','我需要技术支持','For platform issues, integration questions, or bug reports. Priority support for existing clients.','针对平台问题、集成疑问或缺陷报告。现有客户享受优先支持。','Open Support Ticket','提交支持工单','P1 < 1hr, Std < 4hrs', 'P1 < 1hr, Std < 4hrs'],
          [
            ...
            'Media & Press Inquiries','媒体与新闻咨询','For journalists, analysts, and media professionals seeking comment, data, or speaking opportunities.','面向寻求评论、数据或演讲机会的记者、分析师和媒体专业人士。','Contact Press Team','联系公关团队','24 hours', '24 hours'],
          [
            ...
            'Something else?','其他问题？','For any other questions, partnership ideas, or feedback. We read everything.','任何其他问题、合作想法或反馈。我们会阅读所有内容。','Send a Message','发送消息','2 business days', '2 business days'],
...
/* ─────────────────────────────────────────────
   LOGIN PAGE
───────────────────────────────────────────── */
// Multi-language login configuration helper
const LOGIN_CFG_ML = {
  dsp: {
    class:'dsp', badge:'DSP', badgeColor:'#EC4899',
    subtitle: { en:'Demand-Side Platform', zh:'需求方平台' },
    tagline: { en:'Reach the world. Drive results.', zh:'触达全球。驱动成果。' },
    heading: { en:'Sign in to NexBids DSP', zh:'登录 NexBids DSP' },
    newLink: { en:'New to NexBids DSP? Contact Sales', zh:'NexBids DSP新用户？联系销售' },
    stats: [['50K+','Advertisers','广告主'],['30+','Ad Formats','广告格式']],
    quoteEn: 'NexBids DSP transformed our ROAS by 3.2x in just 90 days.',
    quoteZh: 'NexBids DSP 在短短90天内将我们的ROAS提高了3.2倍。',
    quoteByEn: '— Marketing Director, Global E-commerce Brand',
    quoteByZh: '— 全球电商品牌营销总监'
  },
  ssp: {
    class:'ssp', badge:'SSP', badgeColor:'#34D399',
    subtitle: { en:'Supply-Side Platform', zh:'供应方平台' },
    tagline: { en:'More demand. More revenue. More control.', zh:'更多需求。更多收益。更多控制。' },
    heading: { en:'Sign in to NexBids SSP', zh:'登录 NexBids SSP' },
    newLink: { en:'New publisher? Start Monetizing', zh:'新发布商？开始变现' },
    stats: [['30K+','Publishers','发布商'],['+52%','Avg eCPM Lift','平均eCPM提升']],
    quoteEn: 'Our eCPM increased by 67% after implementing NexBids header bidding.',
    quoteZh: '实现NexBids头部竞价后，我们的eCPM提升了67%。',
    quoteByEn: '— Publisher Operations Lead, Regional News Network',
    quoteByZh: '— 区域新闻网络发布商运营负责人'
  },
  adx: {
    class:'adx', badge:'ADX', badgeColor:'#A78BFA',
    subtitle: { en:'Ad Exchange', zh:'广告交易中枢' },
    tagline: { en:'The world\'s most transparent programmatic marketplace.', zh:'全球最透明的程序化广告市场。' },
    heading: { en:'Sign in to NexBids ADX', zh:'登录 NexBids ADX' },
    newLink: { en:'New ADX partner? Contact ADX Team', zh:'新ADX合作伙伴？联系ADX团队' },
    stats: [['50B+','Daily Auctions','日竞价'],['<100ms','Bid Response','竞价响应']],
    quoteEn: 'NexBids ADX provides unmatched transparency and speed in programmatic buying.',
    quoteZh: 'NexBids ADX在程序化购买中提供无与伦比的透明度和速度。',
    quoteByEn: '— Ad Operations Director, Premium Publisher Network',
    quoteByZh: '— 高端发布商网络广告运营总监'
  }
};

function renderLogin(platform) {
  const mlCfg = LOGIN_CFG_ML[platform];
  const lang = currentLang || "en";
  const getLocalized = (field) => {
    if (!mlCfg[field]) return "";
    return mlCfg[field][lang] || mlCfg[field].en || "";
  };
  const c = mlCfg;
  return `
  <div class="login-page">
    <div class="login-left ${c.class}">
      ...
      <div class="login-platform-badge" style="background:rgba(255,255,255,0.08);color:${c.badgeColor}">
        ${c.badge} — ${getLocalized("subtitle")}
      </div>
      <h2>${getLocalized("tagline")}</h2>
      <p>${getLocalized('welcome_text')}</p>
    ...
    <div class="login-right">
      <div class="login-form-wrap">
        ...
        <div class="login-links" style="margin-top:20px">
          <a onclick="navigate('contact')" style="color:var(--text-muted);font-size:13px">${getLocalized("newLink")}</a>
...
───────────────────────────────────────────── */
console.log('[DEBUG] Starting IIFE initGlobalTrafficMap...');
(function initGlobalTrafficMap() {
  console.log('[DEBUG] Inside IIFE initGlobalTrafficMap');
  ...
  console.log('[DEBUG] IIFE initialization complete - _initGTM function defined');
})();
console.log('[DEBUG] IIFE executed successfully');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('[DEBUG] pageContainer element:', !!document.getElementById('pageContainer'));
  console.log('[DEBUG] navMenu element:', !!document.getElementById('navMenu'));
  console.log('[DEBUG] footer element:', !!document.getElementById('footer'));
  
  // Build navigation menu
  const navMenu = document.getElementById('navMenu');
  console.log('[DEBUG] Building nav menu, navMenu element:', !!navMenu);
  if (navMenu) {
    navMenu.innerHTML = `
      <button class="nav-item" onclick="navigate('home')" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0">${t('Home', '首页')}</button>
      <div class="nav-item dropdown" style="position:relative;display:inline-block">
        <button onclick="document.getElementById('solutionsDropdown').style.display = document.getElementById('solutionsDropdown').style.display === 'none' ? 'block' : 'none'; event.stopPropagation()" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0;display:flex;align-items:center;gap:6px">${t('Solutions', '解决方案')} <span style="font-size:10px">▼</span></button>
        <div id="solutionsDropdown" class="dropdown-menu" style="position:absolute;top:calc(100% + 8px);left:0;background:#0F1629;border:1px solid rgba(255,255,255,0.1);border-radius:8px;min-width:200px;display:none;z-index:100;box-shadow:0 4px 20px rgba(0,0,0,0.4)">
          <a class="dropdown-item" onclick="navigate('solutions-advertiser'); document.getElementById('solutionsDropdown').style.display='none'" style="display:block;padding:12px 16px;cursor:pointer;color:inherit;text-decoration:none;transition:background 0.2s">${t('Advertiser Solutions', '广告主解决方案')}</a>
          <a class="dropdown-item" onclick="navigate('solutions-publisher'); document.getElementById('solutionsDropdown').style.display='none'" style="display:block;padding:12px 16px;cursor:pointer;color:inherit;text-decoration:none;transition:background 0.2s">${t('Publisher Solutions', '发布商解决方案')}</a>
          <a class="dropdown-item" onclick="navigate('solutions-agency'); document.getElementById('solutionsDropdown').style.display='none'" style="display:block;padding:12px 16px;cursor:pointer;color:inherit;text-decoration:none;transition:background 0.2s">${t('Agency Solutions', '代理商解决方案')}</a>
        </div>
      </div>
      <div class="nav-item dropdown" style="position:relative;display:inline-block">
        <button onclick="document.getElementById('productsDropdown').style.display = document.getElementById('productsDropdown').style.display === 'none' ? 'block' : 'none'; event.stopPropagation()" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0;display:flex;align-items:center;gap:6px">${t('Products', '产品')} <span style="font-size:10px">▼</span></button>
        <div id="productsDropdown" class="dropdown-menu" style="position:absolute;top:calc(100% + 8px);left:0;background:#0F1629;border:1px solid rgba(255,255,255,0.1);border-radius:8px;min-width:200px;display:none;z-index:100;box-shadow:0 4px 20px rgba(0,0,0,0.4)">
          <a class="dropdown-item" onclick="navigate('products-dsp'); document.getElementById('productsDropdown').style.display='none'" style="display:block;padding:12px 16px;cursor:pointer;color:inherit;text-decoration:none;transition:background 0.2s">NexBids DSP</a>
          <a class="dropdown-item" onclick="navigate('products-adx'); document.getElementById('productsDropdown').style.display='none'" style="display:block;padding:12px 16px;cursor:pointer;color:inherit;text-decoration:none;transition:background 0.2s">NexBids ADX</a>
          <a class="dropdown-item" onclick="navigate('products-ssp'); document.getElementById('productsDropdown').style.display='none'" style="display:block;padding:12px 16px;cursor:pointer;color:inherit;text-decoration:none;transition:background 0.2s">NexBids SSP</a>
        </div>
      </div>
      <button class="nav-item" onclick="navigate('technology')" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0">${t('Technology', '技术')}</button>
      <button class="nav-item" onclick="navigate('resources')" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0">${t('Resources', '资源')}</button>
      <button class="nav-item" onclick="navigate('case-studies')" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0">${t('Case Studies', '案例')}</button>
      <button class="nav-item" onclick="navigate('company')" style="background:none;border:none;color:inherit;font-size:inherit;cursor:pointer;padding:0">${t('Company', '公司')}</button>
    `;
    // Close dropdowns when clicking outside
    document.addEventListener('click', (e) => {
      if (!e.target.closest('.dropdown')) {
        document.getElementById('solutionsDropdown').style.display = 'none';
  ...
  console.log('[DEBUG] Before render: footer element:', !!footer);
  if (footer) {
    console.log('[DEBUG] Generating footer HTML...');
    footer.innerHTML = `
    <div class="container">
      <div class="footer-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:32px;margin-bottom:40px;">
        <div class="footer-col">
          <h4 style="font-weight:700;margin-bottom:12px;cursor:pointer;user-select:none">${t('Solutions', '解决方案')}</h4>
          <ul style="list-style:none;opacity:0.8">
            <li><a onclick="navigate('solutions-advertiser')" style="cursor:pointer">${t('For Advertisers', '广告主方案')}</a></li>
            <li><a onclick="navigate('solutions-publisher')" style="cursor:pointer">${t('For Publishers', '发布商方案')}</a></li>
            <li><a onclick="navigate('solutions-agency')" style="cursor:pointer">${t('For Agencies', '代理商方案')}</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4 style="font-weight:700;margin-bottom:12px;cursor:pointer;user-select:none">${t('Products', '产品')}</h4>
          <ul style="list-style:none;opacity:0.8">
            <li><a onclick="navigate('products-dsp')" style="cursor:pointer">NexBids DSP</a></li>
            <li><a onclick="navigate('products-adx')" style="cursor:pointer">NexBids ADX</a></li>
            <li><a onclick="navigate('products-ssp')" style="cursor:pointer">NexBids SSP</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4 style="font-weight:700;margin-bottom:12px;cursor:pointer;user-select:none">${t('Resources', '资源')}</h4>
          <ul style="list-style:none;opacity:0.8">
            <li><a onclick="navigate('resources')" style="cursor:pointer">${t('Documentation', '文档')}</a></li>
            <li><a onclick="navigate('technology')" style="cursor:pointer">${t('Technology', '技术')}</a></li>
            <li><a onclick="navigate('case-studies')" style="cursor:pointer">${t('Case Studies', '案例')}</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4 style="font-weight:700;margin-bottom:12px;cursor:pointer;user-select:none">${t('Company', '公司')}</h4>
          <ul style="list-style:none;opacity:0.8">
            <li><a onclick="navigate('company')" style="cursor:pointer">${t('About', '关于')}</a></li>
            <li><a onclick="navigate('careers')" style="cursor:pointer">${t('Careers', '加入我们')}</a></li>
            <li><a onclick="navigate('contact')" style="cursor:pointer">${t('Contact', '联系我们')}</a></li>
          </ul>
        </div>
      </div>
      <div style="border-top:1px solid rgba(255,255,255,0.08);padding-top:32px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:20px">
        <div>
          <div id="footerTagline" style="font-size:14px;opacity:0.8;margin-bottom:8px"></div>
          <div id="footerCopyright" style="font-size:12px;opacity:0.6"></div>
        </div>
        <div style="display:flex;gap:16px;align-items:center">
          <div id="langSelectorFooter" style="position:relative">
            <button id="langBtnFooter" onclick="toggleLangDropdownFooter()" style="background:none;border:1px solid rgba(255,255,255,0.2);padding:6px 12px;border-radius:4px;color:inherit;cursor:pointer;font-size:12px"></button>
            <div id="langDropdownFooter" style="position:absolute;bottom:calc(100% + 8px);right:0;background:#0F1629;border:1px solid #333;border-radius:8px;min-width:150px;display:none;z-index:100"></div>
          </div>
        </div>
      </div>
    </div>`;
  ...
  console.log('[DEBUG] Before renderPage: renderHome is:', typeof renderHome);
  console.log('[DEBUG] Before renderPage: currentPage is:', currentPage);
  console.log('[DEBUG] Before renderPage: pageContainer is:', !!document.getElementById('pageContainer'));
  
  try {
    renderPage('home');
    console.log('[DEBUG] After renderPage');
  } catch (e) {
    console.error('[ERROR] renderPage failed:', e.message);
    console.error('[ERROR] Stack:', e.stack);
  }
  
  try {
    applyLang();
    console.log('[DEBUG] After applyLang');
  } catch (e) {
    console.error('[ERROR] applyLang failed:', e.message);
  }
  
  try {
    updateNavActive('home');
    console.log('[DEBUG] After updateNavActive');
  } catch (e) {
    console.error('[ERROR] updateNavActive failed:', e.message);
  }
